...
Public Class SQLAccess
    ...
    Protected sqlconnectstring As String = "Data Source=LINHKING-PC\SQLEXPRESS;Initial Catalog=QLSinhVien;Integrated Security=True;"
    Public Sub New()
    ...
    Private Property SqlCommand As SqlCommandBuilder
    ...
    Public Function GetDataReader(ByVal v_sSqlString As String) As SqlDataReader
        Try
            If OpenConnection() Then
                ...
                GetDataReader = SqlCom.ExecuteReader
            End If
    ...
    System.Data.DataTable, Optional ByVal ShowErrorMessage As Boolean = False) As Boolean
        ...
        SqlCommand = New SqlCommandBuilder(SqlDa)
        Try
            If OpenConnection() Then
    ...
    Private Function SqlDataReader() As SqlDataReader
